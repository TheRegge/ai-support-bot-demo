    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">API Usage Monitor</h2>
            <UsageMonitor />
          </section>
          ...
          <section>
            <h2 className="text-xl font-semibold text-gray-800 mb-4">Rate Limit Configuration</h2>
            <div className="bg-white rounded-lg shadow p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-medium mb-3">IP-based Limits</h4>
                ...
                <div>
                  <h4 className="font-medium mb-3">User-based Limits</h4>
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>• Guests: 20 messages per day</li>
                    <li>• Registered: 50 messages per day</li>
          ...
          <section>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-medium mb-3">Input Validation</h4>
                  <ul className="text-sm text-gray-600 space-y-1">
                ...
                <div>
                  <h4 className="font-medium mb-3">Bot Protection</h4>
                  <ul className="text-sm text-gray-600 space-y-1">
                    <li>• Rapid message detection (&lt;2 seconds)</li>
